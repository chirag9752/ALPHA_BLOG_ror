class ArticlesController < ApplicationController
  ...
  def create
    ...
    @article.user =  current_user                        # for user table because we don't make a frontend for adding specifically userId which is a foriegn key that's we do it manually
    if @article.save
